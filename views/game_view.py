...
class GameView(arcade.View):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if len(clicked_tiles) > 0:
            ...
            if tile.current_slot is not None:
                tile.drag_origin_slot = tile.current_slot
                tile.current_slot.holding_tile = False
                tile.current_slot.curr_tile = None
                tile.current_slot = None
            else:
                tile.drag_origin_slot = None
            return
    ...
    def on_mouse_release(self, x, y, button, modifiers):
        ...
        if len(self.held_tiles) > 0:
            self.snap_tile_to_stand(self.held_tiles[0])
    ...
    def snap(self, tile, selected_list):
        ...
        for slot in selected_list:
            ...
            if difference < current_best and slot.curr_tile is None:
        ...
        if best_slot is not None and current_best < snap_threshold:
            best_slot.tile = tile
            tile.current_slot = best_slot
            tile.center_x = best_slot.center_x
            tile.center_y = best_slot.center_y
        elif tile.current_slot is not None:
            tile.center_x = tile.current_slot.center_x
            tile.center_y = tile.current_slot.center_y
